...
set SUPABASE_SERVICE_ROLE_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9hdml6c2JjdXJ0bnNla3V3ZWJqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MzgxNjc3OCwiZXhwIjoyMDg5MzkyNzc4fQ.omk7Ydv5FXwhlBBW2Tog5aWEguFm8jegv5HLd_fGJ0g
set APP_FILE_PATHS=C:/shared-files

echo Environment variables set successfully!
echo SUPABASE_URL: %SUPABASE_URL%
echo APP_FILE_PATHS: %APP_FILE_PATHS%
echo.
